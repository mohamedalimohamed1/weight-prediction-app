...
# Klasörleri oluştur
os.makedirs("./visualization/knn_graphs", exist_ok=True)
os.makedirs("./models/knn_model", exist_ok=True)
...
# Pipeline: Ön işleme ve KNN modelini birleştir
...
plt.grid(True)
plt.savefig("./visualization/knn_graphs/veri_bolunmesi.png")
plt.close()
...
model_path = "./models/knn_model/knn_model_pipeline.joblib"
...
plt.legend()
plt.grid(True)
plt.savefig("./visualization/knn_graphs/egitim_sonuclari_grafik.png")
plt.close()
...
plt.legend()
plt.grid(True)
plt.savefig("./visualization/knn_graphs/test_sonuclari_grafik.png")
plt.close()
